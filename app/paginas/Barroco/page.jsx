...
function Barroco(){
    return(
        ...
        <div className="corpo">
            <p className={open.className} > O movimento barroco, que floresceu principalmente nos séculos XVII e XVIII, representa um dos períodos mais fascinantes e ricos da 
