...
function Abstracionismo(){
    return(
        ...
        <div className="corpo">
            <p className={open.className}> O Abstracionismo, um movimento artístico que surgiu no início do século XX, representa uma das rupturas mais radicais com a 
